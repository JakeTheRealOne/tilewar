...
| PUT    | /all.php?action=users       | {email: STRING, password: STRING}                                              | {return: INT, users: COLLECTION}      | Get all users (email list)                           |
| PUT    | /all.php?action=categories  | {email: STRING, password: STRING}                                              | {return: INT, categories: COLLECTION} | Get all categories (id and title list)               |
| PUT    | /all.php?action=tiles       | {email: STRING, password: STRING}                                              | {return: INT, tiles: COLLECTION}      | Get all tiles (id, category, title and content list) |
